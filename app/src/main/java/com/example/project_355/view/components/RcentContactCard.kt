...
//
//@Composable
//fun RecentContactCard(contact: RecentContact, modifier: Modifier = Modifier, showTime: Boolean = false, onClick: (()->Unit)? = null){
//    Row(
//        modifier = modifier
//            .fillMaxWidth()
...
//            }
//
//            Square(size = 50.dp, backGroundColor = Color.White, elevation = 3.dp) {
